                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">Rs. {{ $this->totalShippingAmount }}</span>
                        </h4>
                        <hr>
                ...
                <div class="col-md-12">
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-1">Postel Code (Zip Code)</label>
                                <input type="number" wire:model.defer="postelcode" class="form-control"
                                ...
                                <div class="d-md-flex align-items-start">
                                    ...
                                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                        <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel"
                                            ...
                                            <hr />
                                            <button wire:loading.attr="disabled" type="button" wire:click="codOrder" class="btn btn-primary">
